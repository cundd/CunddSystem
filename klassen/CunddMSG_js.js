...
// class CunddBenutzer_js{
	...
	CunddMSG_js.prototype.mouse_over = function(aufrufer){
		...
		aufrufer.onclick = function(){
			...
			var aufruf = {name: "aufruf", value: "CunddMSG::detail"};
			var inhalt =[];
			inhalt.push(aufruf); // "Aufruf"-Objekt anhängen
			/* Den alten Benutzer als Objekt erstellen. */
			var msg_id = {name: "msg_id", value: aufrufer.id};
			inhalt.push(msg_id); // "alter_benutzer"-Objekt anhängen
	...
	CunddMSG_js.prototype.mouse_out = function(aufrufer){
	...
	CunddMSG_js.eintrag_inhalt_aendern = function(aufrufer){
