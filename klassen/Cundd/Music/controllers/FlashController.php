 ...
 * @license 
 * @copyright 
 * Die Klasse Cundd_Music_FlashController erweitert Cundd_Music_AbstractController.
 * @package Cundd_Music
 * @version 1.0
 * @since Jan 21, 2010
 * @author daniel
 */
class Cundd_Music_FlashController extends Cundd_Music_controllers_AbstractController{
	//MWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMW
	//MWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMWMW
