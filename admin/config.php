...
# Pfad zu den Dateien verschiedener Medien, wie Bilder, SWF, etc.
CunddMediaPath = ./pics/page/

# Link zur Galerie auf dem Server
galerie_link = "./galerie.php"
galerie_link_aktiv = 1
...
CunddAjaxPHP_verweis = ./CunddAjax_verweis.php
...
BasePath = CunddSystem/
CunddBasePath = Cundd/
CunddBaseUrl = www.cundd.net
